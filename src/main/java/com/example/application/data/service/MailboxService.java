...
//        ds.setPassword(Configuration.decodePassword(conf.getPassword()));
        ...
        try {
            System.out.println(configuration.getUserName()+"8888888888888888888888888888888888888888888888888");
        ...
        try {
            ...
            if (count != null && count > 0) {
                ...
                String insertQuery = "INSERT INTO FVM_MONITOR_ALERTING " +
                        "(MAIL_EMPFAENGER, MAIL_CC_EMPFAENGER, MAIL_BETREFF, MAIL_TEXT, CRON_EXPRESSION, ISBACKJOBACTIVE, RETENTION_TIME, MAX_PARALLEL_CHECKS, ISMBWATCHDOGACTIVE) " +
                        "VALUES (?, ?, ?, ?, ?, ?, ?,?,?)";
